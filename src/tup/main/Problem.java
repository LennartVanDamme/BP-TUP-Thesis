...
public class Problem {
    ...
    public int[][] games; //games [gameID=nGames][index0=hometeam,index1=awayteam]
    ...
    public Problem(int nTeams, int[][] dist, int[][] opponents, int q1, int q2, String name) {
        ...
        /*  Hier wordt de opponents matrix gelezen en worden de games gecreëerd.
            Als de waarde in de opponents matric groter is dan 0 dan speelt dit team een wedstrijd
            in het stadium van TEAM teagen TEAM.
        *   gameToRounds wordt geinitialiseerd.
        *   roundTeamToGame wordt geinitialiseerd.
        * */
        int game = 0;
